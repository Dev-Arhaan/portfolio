...
export const metadata: Metadata = {
  title: "Arhaan | Personal Portfolio",
  description: "Arhaan is a full-stack developer with 1 year of experience.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body className={`${inter.className} bg-gray-50 relative text-gray-950  pt-28 sm:pt-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}>
